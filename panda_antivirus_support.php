...
<html lang="en">
<head>
<title>Support 24 Hours | Panda Antivirus Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Panda Antivirus Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='panda_antivirus_support' and page_name='panda_antivirus_support'");
...
<h12>SERVICES FOR PANDA ANTIVIRUS</h12><br />
<?php

$result=mysql_query("select * from about where head='SERVICES FOR PANDA ANTIVIRUS' and page_name='panda_antivirus_support'");
echo mysql_result($result,0,"text");?>

Panda is antivirus software. It protects the computer against viruses, spywares and malwares. Panda's products include security tools for home users and enterprises, including protection against cybercrime and kinds of malware that can damage IT, such as spam, hackers, spyware, dialers and undesirable web content, as well as detection of Wi-Fi intrusions. Our virus removal specialist will run virus checks and will clean all infections form the computer.
<br /><br />
