...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Att Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='att_support' and page_name='att_support'");
...
<h12>SERVICES FOR ATT EMAIL</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR ATT EMAIL' and page_name='att_support'");
echo mysql_result($result,0,"text");?>
<br /><br />
