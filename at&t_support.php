...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;At&t Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='att&t_support' and page_name='at&t_support'");
...
<h12>SERVICES FOR AT&T EMAIL</h12><br />
<?php
