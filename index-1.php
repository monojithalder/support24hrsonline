...
<html lang="en">
<head>
<title>Support 24 Hours | About us</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;About Us</h10><br /><br />
<h12>Technical Support by Windows Professionals.</h12><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='Technical Support by Windows Professionals.' and page_name='about'");
...
<h12>"Customers Satisfaction Is Our Moto!"</h12><br />
<?php
$cont='"Customers Satisfaction Is Our Moto!"';
$result1=mysql_query("select * from about where head='$cont' and page_name='about'");
echo mysql_result($result1,0,"text");
?>
<br /><br />

<h12>HOW WE PROVIDE SUPPORT?</h12><br /><br />

<?php
$result2=mysql_query("select * from about where head='HOW WE PROVIDE SUPPORT?' and page_name='about'");
echo mysql_result($result2,0,"text");
?>
</div>
...
<li><a class="active" href="index-1.php">About Us</a></li>
