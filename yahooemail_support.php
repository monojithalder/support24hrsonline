...
<html lang="en">
<head>
<title>Support 24 Hours | Yahoo Email Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Yahoo  Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='yahooemail_support' and page_name='yahooemail_support'");
...
<h12>SERVICES FOR YAHOO EMAIL</h12><br /><br>
<?php
...
<li><i class="icon-li icon-ok"></i>YAHOO Messenger not working.</li>
