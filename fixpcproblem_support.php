...
<html lang="en">
<head>
<title>Support 24 Hours | Fix PC Problem Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Fix PC Problem Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='fixpcproblem_support' and page_name='fixpcproblem_support'");
...
<h12>SERVICES FOR FIX PC PROBLEM</h12><br />
<?php
