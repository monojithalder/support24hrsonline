...
<html lang="en">
<head>
<title>Support 24 Hours | Epson Printer Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Epson Printer Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='epsonprinter_support' and page_name='epsonprinter_support'");
...
<h12>SERVICES FOR EPSON PRINTER</h12><br />
<?php
