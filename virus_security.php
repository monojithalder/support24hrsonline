...
<html lang="en">
<head>
<title>Support 24 Hours | Virus Security</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Virus & Security</h10><br /><br />
<h12>Technical Support by Windows Professionals.</h12><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='Technical Support by Windows Professionals.' and page_name='virus_security'");
...
<h12>VIRUS AND SECURITY SOLUTION</h12><br />
...
<h12>BENEFITS TO GET SUPPORT FOR VIRUS REMOVAL</h12><br /><br />
<ul class="icons-ul">
 <?php
