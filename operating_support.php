...
<html lang="en">
<head>
<title>Support 24 Hours | Operating System Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Operating System</h10><br /><br />
<h12>Technical Support by Windows Professionals.</h12><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='Technical Support by Windows Professionals.' and page_name='operating_support'");
...
<br /><br />
<h12>WHAT WE OFFER IN ADDITION</h12><br /><br />
<ul class="icons-ul">
<?php
