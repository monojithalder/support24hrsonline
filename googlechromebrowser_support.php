...
<html lang="en">
<head>
<title>Support 24 Hours | Google Chrome Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Google Chrome Support</h10><br /><br />

<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='googlechromebrowser_support' and page_name='googlechromebrowser_support'");
...
<h12>SERVICES FOR GOOGLE CHROME</h12><br />
<?php
...
Google Chrome cannot guarantee an uninterrupted trouble-free browsing experience. Support is very much required for this browser. Support provided by us:
<br /><br />
