...
<html lang="en">
<head>
<title>Support 24 Hours | Windows 7 Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Windows 7 Support</h10><br /><br />

<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='windows7_support' and page_name='windows7_support'");
...
<h12>SERVICES FOR WINDOWS 7</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR WINDOWS 7' and page_name='windows7_support'");
...
<?php
 $result=mysql_query("select * from about where head='WHAT DO WE GET' and page_name='windows7_support'");
...
<ul class="icons-ul">
<li><i class="icon-li icon-ok"></i>Activation and browsing issues.</li>
<li><i class="icon-li icon-ok"></i>Blue Screen Of Death (BSOD).</li>
<li><i class="icon-li icon-ok"></i>Help you use and setup new features.</li>
<li><i class="icon-li icon-ok"></i>Blue screen errors.</li>
<li><i class="icon-li icon-ok"></i>Networking setup and troubleshooting.</li>
<li><i class="icon-li icon-ok"></i>Operating system compatibility to other programs.</li>
<li><i class="icon-li icon-ok"></i>Schedule backups; restore files or folders that get accidentally deleted.</li>
<li><i class="icon-li icon-ok"></i>Secure, troubleshoot and fix Windows 7 issues.</li>
<li><i class="icon-li icon-ok"></i>Setup, install and upgrade to Windows 7.</li>
<li><i class="icon-li icon-ok"></i>Software installation and un-installation.</li>
<li><i class="icon-li icon-ok"></i>Support for non-responding programs.</li>
<li><i class="icon-li icon-ok"></i>Upgrading driver compatibility/updates/installation.</li>
<li><i class="icon-li icon-ok"></i>Wi-fi and bluetooth devices setup.</li>
<li><i class="icon-li icon-ok"></i>Windows 7 installation.</li>
<li><i class="icon-li icon-ok"></i>Windows 7 upgrade from Windows Vista/ XP.</li>
<li><i class="icon-li icon-ok"></i>Windows firewall issues.</li>
</ul>
</div>
