...
<html lang="en">
<head>
<title>Support 24 Hours | Microsoft Outlook Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Microsoft Outlook Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='microsoftoutlook_support' and page_name='microsoftoutlook_support'");
...
<h12>SERVICES FOR MICROSOFT OUTLOOK</h12><br />
<?php
