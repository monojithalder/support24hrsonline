...
<html lang="en">
<head>
<title>Support 24 Hours | Cisco Router Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Cisco Router Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='ciscorouter_support' and page_name='ciscorouter_support'");
...
<h12>SERVICES FOR SISCO ROUTER</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR SISCO ROUTER' and page_name='ciscorouter_support'");
echo mysql_result($result,0,"text");?>
<br /><br />

<h12>WHAT DO WE GET</h12><br /><br />
Speak Support is dedicated in providing you full and Correct information about your Cisco Router and will provide you with a list of common errors that you might crop with your Cisco Router and their Instant Solutions respectively. Which will help you to eliminate the simple problems faster.
<br /><br />

<ul class="icons-ul">
<?php
 $result=mysql_query("select * from about where head='WHAT DO WE GET' and page_name='ciscorouter_support'");
