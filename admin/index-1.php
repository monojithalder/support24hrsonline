...
<strong class="slogon"><b>TOLL FREE:&nbsp;&nbsp;&nbsp;&nbsp; XXX-XX-XXXXXX (US)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;XXX-XX-XXXXXX (AUS)</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;support@support24hrs.com</strong>
<div class="uk"><img src="images/uk.png"> <img src="images/us.png"></div>
</div>
<nav id="main-menu">
<strong></strong>
...
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='Technical Support by Windows Professionals.'");
echo mysql_result($result,0,"text");?>
<br /><br />
<h11 class="icon-phone-sign icon-2x">&nbsp;&nbsp;&nbsp;TOLL FREE<br />
XX-XXX-XXXXXX(US)    XX-XXX-XXXXXXX (Aus)</h11><br /><br />

<h12>"Customers Satisfaction Is Our Moto!"</h12><br />
<?php
$cont='"Customers Satisfaction Is Our Moto!"';
$result1=mysql_query("select * from about where head='$cont'");
...
<?php
$result2=mysql_query("select * from about where head='HOW WE PROVIDE SUPPORT?'");
