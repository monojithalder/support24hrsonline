...
<html lang="en">
<head>
<title>Support 24 Hours |Testimonials</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Customer Review</h10><br /><br />
<h12>What Customer Have To Say.</h12><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='What Customer Have To Say.' and page_name='testi'");
...
{
?>
  <i class="icon-quote-left icon-4x pull-left icon-muted"></i><?php echo $array[$i]; ?><br /> <br />
<?php
}
?>
