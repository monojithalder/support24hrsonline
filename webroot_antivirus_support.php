...
<html lang="en">
<head>
<title>Support 24 Hours | Webroot Antivirus Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Webroot Antivirus Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='webroot_antivirus_support' and page_name='webroot_antivirus_support'");
...
<h12>SERVICES FOR WEBROOT ANTIVIRUS</h12><br />
<?php
...
Support24hours’s support team will support you to remove all infections and viruses from the computers.
<br /><br />
