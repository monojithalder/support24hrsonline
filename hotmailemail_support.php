...
<html lang="en">
<head>
<title>Support 24 Hours | Hotmail Email Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Hotmail Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='hotmailemail_support' and page_name='hotmailemail_support'");
...
<h12>SERVICES FOR HOTMAIL EMAIL</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR HOTMAIL EMAIL' and page_name='hotmailemail_support'");
echo mysql_result($result,0,"text");?>
<br /><br />
<ul class="icons-ul">
<li><i class="icon-li icon-ok"></i>Forgot Password.</li>
<li><i class="icon-li icon-ok"></i>Account Hacked.</li>
<li><i class="icon-li icon-ok"></i>MSN Messenger not working.</li>
<li><i class="icon-li icon-ok"></i>Lost important e-mails.</li>
</ul>
<br /><br />
