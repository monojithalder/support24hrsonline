...
<html lang="en">
<head>
<title>Support 24 Hours | Belkin Router Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Belkin Router Support</h10><br /><br />

<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='belkinrouter_support' and page_name='belkinrouter_support'");
...
<h12>SERVICES FOR BELKIN ROUTER</h12><br />
<?php
