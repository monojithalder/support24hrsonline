...
<html lang="en">
<head>
<title>Support 24 Hours | Diagnosis-Repair Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Diagnosis-Repair Support Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='diagnosisandrepair_support' and page_name='diagnosisandrepair_support'");
...
<h12>SERVICES FOR DIAGNOSIS_REPAIR SUPPORT</h12><br />
<?php
