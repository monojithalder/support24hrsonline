...
<html lang="en">
<head>
<title>Support 24 Hours | Computer Tech Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Computer Tech Support</h10><br /><br />

<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='computertech_support' and page_name='computertech_support'");
echo mysql_result($result,0,"text");?> 
 
<br /><br />
<h11 class="icon-phone-sign icon-2x">&nbsp;&nbsp;&nbsp;TOLL FREE<br />
<samp class="number">1-844-643-0019(USA/CA)</samp> </h11>
	<br /><br />

<h12>SERVICES FOR COMPUTER TECH SUPPORT</h12><br />
<?php
