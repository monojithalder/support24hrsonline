...
<html lang="en">
<head>
<title>Support 24 Hours | Eudora Email Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Eudora Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='eudoraemail_support' and page_name='eudoraemail_support'");
...
<h12>SERVICES FOR EUDORA EMAIL</h12><br />
<?php
