...
<html lang="en">
<head>
<title>Support 24 Hours | Mcafee Antivirus Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Mcafee Antivirus Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='mcafee_antivirus_support' and page_name='mcafee_antivirus_support'");
...
<h12>SERVICES FOR MCAFEE ANTIVIRUS SUPPORT</h12><br />
<?php
