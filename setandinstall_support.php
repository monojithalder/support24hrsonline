...
<html lang="en">
<head>
<title>Support 24 Hours | Set & Install Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Set & Install Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='setandinstall_support' and page_name='setandinstall_support'");
...
<h12>SERVICES FOR SET & INSTALL</h12><br />
<?php
