...
<html lang="en">
<head>
<title>Support 24 Hours | Email Spam Blocker Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Email Spam Blocker Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='emailspamblocker_support' and page_name='emailspamblocker_support'");
...
<h12>SERVICES FOR EMAIL SPAM BLOCKER</h12><br />
<?php
