...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp; Windows 8 Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='windows8_support' and page_name='windows8_support'");
...
<h12>SERVICES FOR WINDOWS 8</h12><br />
<?php
