...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Comcast Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='comcast_support' and page_name='comcast_support'");
...
<h12>SERVICES FOR COMCAST EMAIL</h12><br />
<?php
