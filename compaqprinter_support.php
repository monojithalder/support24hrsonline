...
<html lang="en">
<head>
<title>Support 24 Hours | Compaq Printer Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Compaq Printer Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='compaqprinter_support' and page_name='compaqprinter_support'");
...
<h12>SERVICES FOR COMPAQ PRINTER</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR COMPAQ PRINTER' and page_name='compaqprinter_support'");
echo mysql_result($result,0,"text");?>
<br /><br />
...
<ul class="icons-ul">
<?php
 $result=mysql_query("select * from about where head='WHAT DO WE GET' and page_name='compaqprinter_support'");
