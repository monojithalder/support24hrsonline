...
<html lang="en">
<head>
<title>Support 24 Hours | Blue Screen</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Fix Blue Screen Support</h10><br /><br />
<h12>Technical Support by Windows Professionals.</h12><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='Technical Support by Windows Professionals.' and page_name='blue_screen'");
...
<h12>SERVICES FOR FIX BLUE SCREEN</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR FIX BLUE SCREEN' and page_name='blue_screen'");
echo mysql_result($result,0,"text");?>

<h12>WHAT DO WE GET?</h12><br /><br />
<?php
$result=mysql_query("select * from about where head='WHAT DO WE GET?' and page_name='blue_screen'");
echo mysql_result($result,0,"text");?>
<br /><br />
<ul class="icons-ul">
<li><i class="icon-li icon-ok"></i>Software errors comprising of installed device driver errors.</li>
<li><i class="icon-li icon-ok"></i>Hardware glitches related to hardware device incompatibility, malfunctioning or improper uninstallation.</li>
<li><i class="icon-li icon-ok"></i>Installation errors including a majority of Windows installation errors.</li>
<li><i class="icon-li icon-ok"></i>Startup errors comprising of driver errors and any corrupted system files.</li>
<li><i class="icon-li icon-ok"></i>Errors related to dead hard drive, overheated processor and defective system memory.</li>
</ul>
</div>
