...
<html lang="en">
<head>
<title>Support 24 Hours | Avira Antivirus Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Avira Antivirus Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='avira_antivirus_support' and page_name='avira_antivirus_support'");
echo mysql_result($result,0,"text");?> 

 
<br /><br />
<h11 class="icon-phone-sign icon-2x">&nbsp;&nbsp;&nbsp;TOLL FREE<br />
<samp class="number">1-844-643-0019(USA/CA)</h11><br /><br />

<h12>SERVICES FOR AVIRA ANTIVIRUS</h12><br />
<?php
