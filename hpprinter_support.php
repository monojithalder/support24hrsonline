...
<html lang="en">
<head>
<title>Support 24 Hours | HP Printer Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;HP Printer Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='hpprinter_support' and page_name='hpprinter_support'");
...
<h12>SERVICES FOR HP PRINTER</h12><br />
<?php
