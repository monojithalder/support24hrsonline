...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Cox Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='cox_support' and page_name='cox_support'");
...
<h12>SERVICES FOR COX EMAIL</h12><br />
<?php
