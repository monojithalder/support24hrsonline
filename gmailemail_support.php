...
<html lang="en">
<head>
<title>Support 24 Hours | Gmail Email Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Gmail Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='gmailemail_support' and page_name='gmailemail_support'");
...
<h12>SERVICES FOR GMIAL EMAIL</h12><br />
<?php
...
<li><i class="icon-li icon-ok"></i>Gtalk or Google Messenger not working.</li>
