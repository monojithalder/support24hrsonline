...
<html lang="en">
<head>
<title>Support 24 Hours | Windows XP Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Windows XP Support</h10><br /><br />

<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='windowsxp_support' and page_name='windowsxp_support'");
...
<h12>SERVICES FOR WINDOWS XP</h12><br />
<?php
$result=mysql_query("select * from about where head='SERVICES FOR WINDOWS XP' and page_name='windowsxp_support'");
...
Our certified engineers will troubleshoot problems with your Windows XP Operating System. We can assist in Setup, upgrade, installation and customization of Windows XP on your computer. Do not hesitate to contact the XP tech support helpdesk at Support24hours whenever you need help. If you need help installing Windows XP, we can guide you through the process or simply do the installation for you. Support24hours tech support covers repair and maintenance of your operating system for problems with start-up, shutdown, partition planning, memory management, and registry conflicts.
<br /><br />

<ul class="icons-ul">
<?php
 $result=mysql_query("select * from about where head='WHAT DO WE GET' and page_name='windowsxp_support'");
