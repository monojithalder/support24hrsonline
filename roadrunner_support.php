...
<html lang="en">
<head>
<title>Support 24 Hours | AOL Email Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Roadrunner Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='roadrunner_support' and page_name='Roadrunner_support'");
...
<h12>SERVICES FOR ROADRUNNER EMAIL</h12><br />
<?php
