...
<html lang="en">
<head>
<title>Support 24 Hours | G-Data Antivirus Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;G-Data Antivirus Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='gadata_antivirus_support' and page_name='gadata_antivirus_support'");
...
<h12>SERVICES FOR G-DATA ANTIVIRUS</h12><br />
<?php
