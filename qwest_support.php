...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Qwest Email Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='qwest_support' and page_name='qwest_support'");
...
<h12>SERVICES FOR QWEST EMAIL</h12><br />
<?php
