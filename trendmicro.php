...
<html lang="en">
<head>
<title>Support 24 Hours | Trend Micro Antivirus Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Trend Micro Antivirus Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='trendmicro_antivirus_support' and page_name='trendmicro_antivirus_support'");
...
<h12>SERVICES FOR TREND MICRO ANTIVIRUS</h12><br />
<?php
