...
<html lang="en">
<head>
<title>Support 24 Hours | Business Computer Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Business Computer Support</h10><br /><br />
<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='businesscomputer_support' and page_name='businesscomputer_support'");
...
<h12>SERVICES FOR BUSINESS COMPUTER</h12><br />
<?php
