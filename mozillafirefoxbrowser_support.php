...
<html lang="en">
<head>
<title>Support 24 Hours | Mozilla Firefox Support</title>
<meta charset="utf-8">
...
<div class="grid_16 prefix_1"><h10 class="icon-shield icon-3x">&nbsp;&nbsp;&nbsp;Mozilla Firefox Support</h10><br /><br />

<?php 
require_once("dbconnect.php");$result=mysql_query("select * from about where head='mozillafirefoxbrowser_support' and page_name='mozillafirefoxbrowser_support'");
...
<h12>SERVICES FOR MOZILLA FIREFOX BROWSER</h12><br />
<?php
...
Mozilla Firefox cannot guarantee an uninterrupted trouble-free browsing experience. Support is very much required for this browser. Support provided by us:
<br /><br />
